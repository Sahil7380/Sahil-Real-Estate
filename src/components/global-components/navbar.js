			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" /> Techpath@.biz</a></li>
						<li><a href="locations.html"><i className="icon-placeholder" /> Circus Road,Mughalsarai,UP</a></li>
						</ul>
					</div>
					</div>
			...
			<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
				...
				<div className="row">
					...
					<div className="site-logo-wrap">
						...
						<Link to="/"><img src={publicUrl+"assets/img/techpath.png"} alt="Logo" /></Link>
						</div>
