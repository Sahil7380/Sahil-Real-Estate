    ...
    return <div className="ltn__team-area pt-110--- pb-90">
				...
				<div className="row justify-content-center go-top">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<h4><Link to="/team-details">Scarlett Johansson</Link></h4>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="/team-details">John Wick</Link></h4>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="/team-details">Henry Cavill</Link></h4>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="/team-details">Tony Stack</Link></h4>
						<h6 className="ltn__secondary-color">Property Seller</h6>
						<div className="ltn__social-media">
							<ul>
							<li><a href="#"><i className="fab fa-facebook-f" /></a></li>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="/team-details">James Bond</Link></h4>
						<h6 className="ltn__secondary-color">Real Estate Broker</h6>
						<div className="ltn__social-media">
							<ul>
							<li><a href="#"><i className="fab fa-facebook-f" /></a></li>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="/team-details">Chris Hemsworth</Link></h4>
						<h6 className="ltn__secondary-color">Selling Agents</h6>
						<div className="ltn__social-media">
							<ul>
							<li><a href="#"><i className="fab fa-facebook-f" /></a></li>
